...
//		simpleTest();
	...
	public static void simpleTest(){
		int key = 3;
		Skytale c = create(r.file("src/Aufgabe11bSkytale/SkytaleTest").toString(), key);
		String crypt = c.crypt();
		System.out.println("  crypt: " + crypt);
		Skytale c1 = create(crypt, key);
	...
	public static boolean test(int key){
		...
		Skytale c = create(phrase, key);
		String crypt = c.crypt();
		Skytale c2 = create(crypt, key);
	...
	public static final Skytale NaC = new Skytale("", Integer.MIN_VALUE);

	private Skytale(String s, int key) {
		this.s = s;
		this.cr = r.string(s);
		this.key = key;
	...
	public static Skytale create(String s, int key) {
		if (s == null) {
